...
class Data_tr extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view("datatransaksi/vw_data_tr", $data);
    ...
    public function filterByTanggal()
    {
        ...
        $data['totalGaji'] = $this->Data_transaksi_model->getTotalGajiByTanggal($tanggal);
        ...
        $data['penghasilanBersih'] = $data['totalTarif'] - $totalGaji;
